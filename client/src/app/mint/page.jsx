        ...
        {isConnected ? (
          <div className="w-full mt-20 max-w-2xl p-8 bg-gray-800 bg-opacity-80 rounded-lg shadow-lg backdrop-blur-md">
            ...
            <div className="space-y-4">
              ...
              {/* Message and Button */}
              <div className="text-center text-sm mt-4 text-yellow-300">
                {message}
              </div>
              <button
                onClick={listNFT}
              ...
              <button
                ...
                className={
                  "w-full p-3 mt-4 text-white rounded-lg transition duration-300 bg-blue-600 hover:bg-blue-700"
                }
              >
                Profile
              </button>
          ...
          <button
            ...
            type="button"
            className="text-gray-900 mt-[30vh] bg-white hover:bg-gray-100 border border-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-100 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-gray-600 dark:bg-gray-800 dark:border-gray-700 dark:text-white dark:hover:bg-gray-700 me-2 mb-2"
          >
            <svg
              aria-hidden="true"
