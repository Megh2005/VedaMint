        ...
        <div className="flex flex-col items-center justify-center h-screen text-center absolute top-0 z-[-2] w-screen bg-neutral-950 bg-[radial-gradient(ellipse_80%_80%_at_50%_-20%,rgba(120,119,198,0.3),rgba(255,255,255,0))]">
            ...
            <div className="mt-8 gap-20 w-full max-w-5xl">
                <WordPullUp className="w-full text-xl text-gray-200">
                    VedaMint is an innovative web app that allows users to generate NFTs from articles, combining the
                    world of digital art with written content. By transforming articles into unique, tradable digital
                    assets, VedaMint empowers creators and writers to explore new ways of monetizing their work and
                    engaging with their audience. Whether you're a journalist, blogger, or content creator, VedaMint
                    provides a seamless platform to turn your articles into valuable NFTs, offering a creative and
                    secure method for preserving and sharing your intellectual property. With VedaMint, you can easily
                    ...
                    buyers. Join the revolution and start turning your words into digital treasures with VedaMint today
                </WordPullUp>
                <button
